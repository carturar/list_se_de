...
public class ListSE {
    ...
    public void listBoysByLocationByAge(int age, String description)throws ListaSeException {
        validateListEmpty();
        /**
         * llamamos al ayudante y lo colocamos en la cabeza
         */
        Node temp = this.head;
        /**
         ...
         * @param gender
         */
        public void listByGenderAge (Gender gender,int age) throws ListaSeException {
            validateListEmpty();
            /**
 ...
 */
        public void deleteByAgeOlder ( int age) throws ListaSeException {
            /**
         ...
         * @throws ListaSeException
         */
        public void deleteByGender (Gender gender)throws ListaSeException
        {
            /**
             * llamamos el metodo par validar si la lista esta vacia
             */
         ...
         * @param grade grado de la escuela del niño 1 al 5
         * @return retorna la lista de los niños segun el grado indicado
         */
        public int listBoysByGrade ( byte grade){
            /**
             * Cómo no me puedo mover de la cabeza porque se me vuelan todos los niños,
